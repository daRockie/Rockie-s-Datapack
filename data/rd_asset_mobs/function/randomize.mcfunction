...
execute as @e[type=pillager, tag=magic] at @s run function rd_asset_mobs:magicloop

# Fly TNT
execute as @e[tag=flytnt,type=tnt] at @s run function rd_asset_mobs:flytnt
execute as @e[tag=flytnt2,type=tnt] at @s run function rd_asset_mobs:flytnt2