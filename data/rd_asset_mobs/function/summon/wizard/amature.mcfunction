...
summon area_effect_cloud ~ ~ ~ {custom_particle:{type:witch},Radius:0,Duration:4,Tags:["kill_item"]}
summon skeleton ~ ~ ~ {CustomName:[{text:"魔法使い"}],Health:24,Silent:1b,Tags:["RD.has_mana","RD.spawned","RD.initialized","RD.enemy.wizard.0","RD.damage_player_sound"],drop_chances:{head:0f,body:0.01f,legs:0.02f,feet:0.05f},\
equipment:{\
