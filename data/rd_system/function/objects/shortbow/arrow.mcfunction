...
execute if score @s ai_timer matches 40.. run function rd_system:objects/shortbow/poof
...
$execute positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[distance=0.01..2,dx=0,dy=0,dz=0,nbt=!{UUID:$(owner)}] positioned as @s run function rd_system:objects/shortbow/damage with entity @s equipment.head.components."minecraft:custom_data".data
