...
execute if score @s ai_timer matches 40.. run function rd_system:objects/shortbow/poof with entity @s
...
# ダメージ
$execute if score @s ai_timer matches 3.. if entity @e[tag=!RD.shortbow,distance=0.01..2,type=!#minecraft:unliving_objects] run function rd_system:objects/shortbow/damage with storage rockietools:uuid datas."$(UUID)".parent