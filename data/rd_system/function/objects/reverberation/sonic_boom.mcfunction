...
# 破壊
$execute if entity @e[tag=!RD.sonicBoom,distance=0.01..4,type=!#minecraft:unliving_objects] run function rd_system:objects/reverberation/damage with storage rockietools:uuid datas."$(UUID)"

execute at @s run function rd_system:objects/reverberation/sonic_boom with entity @s {}