...
execute as @e[type=armor_stand,tag=RD.fiber,tag=!RD.initialized] at @s run function rd_system:objects/stinger_fiber/tick with entity @s
...
execute as @e[type=#arrows,tag=RD.shortbow_arrow] at @s run function rd_system:objects/arrow/