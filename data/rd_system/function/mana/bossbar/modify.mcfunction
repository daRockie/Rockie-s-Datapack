...
$bossbar set mana_$(id) name ["",{"text":"Mana: (","color":"aqua"},{"color":"aqua","score":{"objective":"RD.mana","name":"@s"}},{"color":"aqua","text":" / "},{"color":"aqua","score":{"objective":"RD.mana.max","name":"@s"}},{"color":"aqua","text":")"}]
