...
summon item ~ ~1 ~ {Item:{id:"minecraft:armor_stand",count:1,components:{"minecraft:entity_data":{id:"minecraft:armor_stand",Small:1b,Marker:1b,Invisible:1b,Tags:["RD.block.interactive.advanced_crafter","RD.type.block"],CustomName:{"color":"yellow","text":"改良型作業台","italic":0b}},"item_model":"crafting_table",enchantment_glint_override:1b,"minecraft:custom_name":{text:"改良型作業台",color:"yellow",italic:0b},"minecraft:lore":[{"text":"普通の作業台では作れないモノを作れる、フシギな作業台。","italic":false,"color":"gray"},{"text":"設計図、説明書付き。","italic":false,"color": "gray"}],"minecraft:rarity":"rare","minecraft:max_stack_size":64}}}
function rd_asset_blocks:interactive/advanced_crafter/utils/remove_register with entity @s {}
kill @s