...
function rd_asset_blocks:interactive/advanced_crafter/check_recipe
...
execute unless items block ~ ~ ~ container.9 * if score @s RD.isCrafting matches 0 if items entity @a player.cursor *[custom_data={TempItem:1b}] run function rd_asset_blocks:interactive/advanced_crafter/utils/change_mode
