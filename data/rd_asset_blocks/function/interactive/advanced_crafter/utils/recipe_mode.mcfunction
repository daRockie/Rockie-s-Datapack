...
execute if items entity @a[distance=..8] container.* *[custom_data~{TempItem:1b}] run function rd_asset_blocks:interactive/advanced_crafter/utils/recipe_mode/reset_screen
