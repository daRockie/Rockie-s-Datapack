...
# マクロを実行
function rd_asset_blocks:interactive/advanced_crafter/utils/storage/recipes/meth/macro with storage rockietools:custom_recipe temp_crafter.current_ingredient