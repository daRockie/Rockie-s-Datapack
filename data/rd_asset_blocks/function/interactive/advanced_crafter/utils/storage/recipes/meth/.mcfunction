...
# マクロを再実行
execute if data storage rockietools:custom_recipe temp_crafter.meta.crafting_slot[-1] run function rd_asset_blocks:interactive/advanced_crafter/utils/storage/recipes/meth/ with storage rockietools:custom_recipe temp_crafter.meta
...
function rd_asset_blocks:interactive/advanced_crafter/utils/storage/recipes/meth/slot_long_loop with storage rockietools:custom_recipe temp_crafter.meta
