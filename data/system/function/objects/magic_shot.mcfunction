...
execute if score @s ai_timer matches 81.. run function system:objects/extinguish
...
execute at @s unless block ~ ~0.5 ~ air unless block ~ ~0.5 ~ light unless block ~ ~ ~ water run function system:objects/ignition