...
execute if entity @e[distance=..4,tag=!fire_shot,type=player] as @e[type=player,distance=0..4] at @s facing entity @e[type=armor_stand,limit=1,sort=nearest,tag=fire_shot] feet rotated ~ 0 run summon slime ^ ^ ^ {Size:2,OnGround:1b,CustomName:"ファイアリーワンドの流れ弾",Silent:1b,Invulnerable:1b,DeathLootTable:"empty",Tags:["fire","proceed","spawned"],equipment:{mainhand:{id:"minecraft:stick",count:1,components:{"minecraft:enchantments":{"minecraft:fire_aspect":2}}}},active_effects:[{id:"minecraft:invisibility",amplifier:1,duration:1000000,show_particles:0b}],attributes:[{id:"minecraft:attack_damage",base:6},{id:"minecraft:attack_knockback",base:2},{id:"minecraft:scale",base:0.1},{id:"movement_speed",base:1}]}
