...
execute if score @s RD.mana.bossbar.fadeout matches ..0 run function system:mana/bossbar/set_player with entity @s {}

execute if score @s RD.mana.operation matches 0 if score @s RD.mana < @s RD.mana.max run function system:mana/add_mana with entity @s {}
execute if score @s RD.mana > @s RD.mana.max run function system:mana/reset_mana with entity @s {}
