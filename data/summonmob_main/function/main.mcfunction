...
# ブーマーゾンビ　召喚
execute as @e[type=minecraft:zombie,tag=!proceed,nbt={IsBaby:0b}] if score @s spawnRandom matches 0..30 run function summonmob_main:summon/summon_bz

# ブーマーミイラ　召喚
execute as @e[type=minecraft:husk,tag=!proceed,nbt={IsBaby:0b}] if score @s spawnRandom matches 0..30 run function summonmob_main:summon/summon_bm
execute as @e[type=minecraft:husk,tag=!proceed,nbt={IsBaby:1b}] if score @s spawnRandom matches 0..30 run function summonmob_main:summon/summon_bm_s
...
# スカウトゾンビ
execute as @e[type=zombie,tag=!proceed] if score @s spawnRandom matches 30..42 run function summonmob_main:summon/summon_scout_z
...
# ベイビーブーマーゾンビ　召喚
execute as @e[type=minecraft:zombie,tag=!proceed,nbt={IsBaby:1b}] if score @s spawnRandom matches 0..30 run function summonmob_main:summon/summon_bz_baby
...
# 見習い魔導士　召喚
execute as @e[type=minecraft:skeleton,tag=!proceed] if score @s spawnRandom matches 0..25 run function summonmob_main:summon/summon_wz1

# エリートスケルトン　召喚
execute as @e[type=minecraft:skeleton,tag=!proceed] if score @s spawnRandom matches 21..31 run function summonmob_main:summon/summon_elite_s
