...
execute if score @s ai_timer_tmp matches 2 facing entity @n[tag=zombies.target,sort=nearest] eyes anchored eyes run function custom_ai:movements/archer_zombie/summon_arrow with entity @s {}
