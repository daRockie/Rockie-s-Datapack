execute at @s run playsound minecraft:entity.spider.death hostile @a ~ ~ ~ 5 2
...
execute at @s store result score @s xDis run data get entity @e[limit=1,sort=nearest,tag=zombies.target] Pos[0] 1000
execute at @s store result score @s yDis run data get entity @e[limit=1,sort=nearest,tag=zombies.target] Pos[1] 1000
execute at @s store result score @s zDis run data get entity @e[limit=1,sort=nearest,tag=zombies.target] Pos[2] 1000
