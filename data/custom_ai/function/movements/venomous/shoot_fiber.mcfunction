...
execute if score @s ai_timer_tmp matches 5 facing entity @e[tag=spider.target,limit=1,sort=nearest] eyes run function custom_ai:movements/venomous/summon_web
