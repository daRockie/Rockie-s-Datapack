...
execute if entity @s[tag=RD.archer_zombie.shooting] run scoreboard players add @s RD.ai_timer 1
execute if score @s[predicate=rd_asset_mobs:in_hostile] RD.ai_timer matches 60.. run function custom_ai:movements/archer_zombie/shoot_bow
