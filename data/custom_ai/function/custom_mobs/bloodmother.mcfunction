...
execute at @s if entity @e[tag=spider.target,distance=0..8] if score @s ai_timer matches 40..45 run summon spider ~ ~ ~ {Tags:["mini_spider","proceed","spawned"],DeathLootTable:empty,DeathTime:19,Health:1f,attributes:[{id:"minecraft:max_health",base:1},{id:"minecraft:scale",base:0.3}]}
