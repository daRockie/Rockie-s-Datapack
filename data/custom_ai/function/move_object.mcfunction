...
execute at @s store result score @s xDis run data get entity @e[limit=1,sort=nearest,tag=zombies.target] Pos[0] 1
execute at @s store result score @s yDis run data get entity @e[limit=1,sort=nearest,tag=zombies.target] Pos[1] 1
execute at @s store result score @s zDis run data get entity @e[limit=1,sort=nearest,tag=zombies.target] Pos[2] 1
