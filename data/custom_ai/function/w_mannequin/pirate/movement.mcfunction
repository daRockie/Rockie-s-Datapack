...
execute if score @s RD.ai_timer matches 20.. run function custom_ai:w_mannequin/pirate/melee with entity @n[type=mannequin,distance=..0.05] equipment.body.components."minecraft:custom_data"
