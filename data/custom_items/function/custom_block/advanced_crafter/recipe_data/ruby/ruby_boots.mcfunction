...
if items block ~ ~ ~ container.23 red_dye[custom_data~{CustomItem:"RD.ruby"}] run return 6
#say RECIPE IS WRONG! RETURN 0
return run function custom_items:custom_block/advanced_crafter/recipe_data/grimoire/freeze