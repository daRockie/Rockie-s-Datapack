...
item replace block ~ ~ ~ container.10 with crafting_table[enchantment_glint_override=1b,custom_name={"text":"クラフト画面を開く","italic":0b,color:yellow},lore=[{"text":"警告：レシピ画面で表示されているアイテムと所持しているアイテムを置き換えると消滅します！",italic:0b,color:red,bold:1b}],custom_data={TempItem:1b}]
