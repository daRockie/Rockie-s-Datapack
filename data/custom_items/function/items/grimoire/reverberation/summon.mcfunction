...
summon armor_stand ~ ~ ~ {Pose:{Head:[0.1f,0.1f,0.1f]},NoGravity:1b,Invulnerable:1b,ShowArms:0b,Small:1b,Invisible:1b,NoBasePlate:1b,Tags:["RD.sonicBoom","RD.spawned"]}
