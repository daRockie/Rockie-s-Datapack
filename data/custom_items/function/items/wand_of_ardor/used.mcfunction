execute unless score @s RD.mana matches 50.. run return run function custom_items:items/not_enough_mana
...
particle entity_effect{color:[1, 1, 1, 1]} ~ ~1 ~ 0.5 0.5 0.5 0 25
